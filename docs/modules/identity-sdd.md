...
interface PermissionManager {
  ...
  /** 批量检查权限 */
  hasPermissions(userId: string, permissions: string[], tenantId: string): Promise<Map<string, boolean>>
...
interface MfaManager {
  ...
  /** 信任当前设备 */
  trustDevice(userId: string, deviceFingerprint: string, metadata: DeviceMetadata): Promise<TrustedDevice>
