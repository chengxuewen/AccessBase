...
> **Implementation status (2026-09-23 gap audit):** `partial` — vitest 972 + e2e 138+3 green; 80% coverage target not met (ratchet floors 46-77). See [gap-audit](../superpowers/reports/2026-09-23-gap-audit.md).
