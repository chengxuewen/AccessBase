...
> **Implementation status (2026-09-23 gap audit):** `design-only (deferred)` — optimistic-lock model (users.version) never implemented (A11). See [gap-audit](../superpowers/reports/2026-09-23-gap-audit.md).
